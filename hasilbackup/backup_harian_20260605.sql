...
--
-- Temporary table structure for view `penerbangan_barat`
--
...
/*!50001 CREATE TABLE `penerbangan_barat` (
 `id_penerbangan` tinyint NOT NULL,
  `id_maskapai` tinyint NOT NULL,
  `nama_maskapai` tinyint NOT NULL,
  `kode_maskapai` tinyint NOT NULL,
  `asal_bandara` tinyint NOT NULL,
  `nama_bandara_asal` tinyint NOT NULL,
  `kode_bandara_asal` tinyint NOT NULL,
  `kota_asal` tinyint NOT NULL,
  `tujuan_bandara` tinyint NOT NULL,
  `nama_bandara_tujuan` tinyint NOT NULL,
  `kode_bandara_tujuan` tinyint NOT NULL,
  `kota_tujuan` tinyint NOT NULL,
  `tanggal_berangkat` tinyint NOT NULL,
  `jam_berangkat` tinyint NOT NULL,
  `jam_tiba` tinyint NOT NULL,
  `harga` tinyint NOT NULL,
  `kursi_tersedia` tinyint NOT NULL,
  `status_penerbangan` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `penerbangan_timur`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `penerbangan_timur` (
 `id_penerbangan` tinyint NOT NULL,
  `id_maskapai` tinyint NOT NULL,
  `nama_maskapai` tinyint NOT NULL,
  `kode_maskapai` tinyint NOT NULL,
...
--
-- Temporary table structure for view `vw_jadwal_penerbangan`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_jadwal_penerbangan` (
 `id_penerbangan` tinyint NOT NULL,
  `id_maskapai` tinyint NOT NULL,
  `nama_maskapai` tinyint NOT NULL,
  `kode_maskapai` tinyint NOT NULL,
...
/*!50001 DROP TABLE IF EXISTS `penerbangan_barat`*/;
/*!50001 DROP VIEW IF EXISTS `penerbangan_barat`*/;
...
/*!50001 DROP TABLE IF EXISTS `penerbangan_timur`*/;
/*!50001 DROP VIEW IF EXISTS `penerbangan_timur`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 DROP TABLE IF EXISTS `vw_jadwal_penerbangan`*/;
/*!50001 DROP VIEW IF EXISTS `vw_jadwal_penerbangan`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
-- Dump completed on 2026-06-05 11:01:53
