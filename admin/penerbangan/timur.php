<?php
$page_title = "Penerbangan Wilayah Timur";
...
$flights = [];
try {
    // Querying database view `penerbangan_timur`
...
<div class="admin-wrapper">
    ...
    <main class="admin-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h3 class="fw-bold mb-1"><i class="fa-solid fa-compass text-info me-2"></i> Penerbangan Wilayah Timur</h3>
                <p class="text-muted mb-0">Menampilkan data fragmentasi horizontal dari view <code>penerbangan_timur</code> (Asal: Makassar, Ambon, Jayapura).</p>
            </div>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        <?php if (!empty($flights)): ?>
                            <?php foreach ($flights as $f): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-1 font-monospace fw-bold text-info">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="7" class="text-center py-4 text-muted">Tidak ada jadwal penerbangan Timur saat ini.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
